...
public class TerminalApiClientNoAuthPingTest {
    ...
    public void A_givenGoodStatus_whenNoAuthPingJsonRequest_thenResponseStatusIsGood() {
        for (int i = 0; i < tests; i++) {
            ...
            Response response = client.postPingNoAuth();
            long elapsedTime = System.currentTimeMillis() - startTime;
            System.out.println(i+"("+elapsedTime + " ms) Ping test, response : "+ response.readEntity(String.class));
