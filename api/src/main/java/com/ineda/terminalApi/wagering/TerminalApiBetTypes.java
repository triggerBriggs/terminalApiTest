...
public enum TerminalApiBetTypes {
    ...
    TerminalApiBetTypes(final String code, int betTypeID, boolean multiLeg, boolean multiRace, boolean boxed, int legs) {
        this.code = code;
     ...
     */
    public static TerminalApiBetTypes fromCode(String text) {
        if (text != null) {
            for (TerminalApiBetTypes b : TerminalApiBetTypes.values()) {
     ...
     * @return Bet types object or null if not found
     */
    public static TerminalApiBetTypes fromBetTypeId(int betTypeID) {
        if (betTypeID>0) {
            for (TerminalApiBetTypes b : TerminalApiBetTypes.values()) {
