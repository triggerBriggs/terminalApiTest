...
public enum TerminalApiError
{
    ...
    TerminalApiError(int code, String s)
    {
        this.code = code;
    }

    public static TerminalApiError fromCode(int code) {
        for (TerminalApiError t : TerminalApiError.values()) {
            if (code==t.code)
                return t;
        }
